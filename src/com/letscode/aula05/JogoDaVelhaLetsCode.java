package com.letscode.aula05;

import java.util.*;

public class JogoDaVelhaLetsCode {
    ...
    private static void playersTurn() {
        ...
        System.out.println("Insira sua posição : (1-9)");
        ...
        while (playerPositions.contains(playerPosition) || computerPositions.contains(playerPosition) ||
            ...
            System.out.println("Posição insira uma posição válida: ");
    ...
    private static void printGameBoard(char[][] gameBoard, String user) {
        if (user.equalsIgnoreCase("player")) {
            System.out.println("Movimento do player : ");
        } else {
            System.out.println("Movimento do computador : ");
        }
    ...
    private static void printResult(int result) {
        ...
        System.out.println("Quer jogar de novamente ? S / N");
        Scanner scanner = new Scanner(System.in);
